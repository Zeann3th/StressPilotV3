...
public interface OltpRequestLogRepository extends JpaRepository<RequestLogEntity, Long> {
    ...
    """)
    List<Object[]> getRunSummaryStats(@Param("runId") Long runId);
    ...
    """)
    List<Object[]> getEndpointSummaryStats(@Param("runId") Long runId);
}
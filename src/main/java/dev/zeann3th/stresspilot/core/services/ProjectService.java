...
public interface ProjectService {
    ...
    ProjectEntity updateProject(UpdateProjectCommand command);

    void deleteProject(Long projectId);

    ResponseEntity<ByteArrayResource> exportProject(Long projectId);

    ResponseEntity<ProjectEntity> importProject(MultipartFile file);
}
